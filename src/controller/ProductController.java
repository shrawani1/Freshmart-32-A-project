...
public class ProductController {
    ...
    // (productId,productName,productQty,productPrice,productCategory)
    // values(%d,'%s',%d,%d,'%s')",
    // id,
    ...
    // "update product_table set productId = '" + id + "',productName ='" + name +
    // "',productQty='" + qty
    // + "',productPrice='" + price + "',productCategory ='" + category + "' where
    // productId ='%d' ",
    // id,
    // name, qty, price, category);
